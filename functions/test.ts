...
import { POST, CATEGORY } from './firebase-cms/src/model/forum/forum.interface';
...
class AppTest {
  ...
  //   return await this.forum.createCategory(category);
  ...
  // async createPost(p) {
  //   //let data = this.testPostData();

  //   //data.categories = { 'wrong-category': true };
  ...
  //   // 
  //   return await this.forum.createPost(p);




  //   // creating a post with wrong categoreis.
  //   // you must check if categories are exist or not before creating a post.
  //   // it is very difficult to monitor ref.set.then. use async and await supported by typescript.
  //   // expect: fail.
  //   //p.categories = { music: true, wrong: true, qna: true, game: true, bebe: true };

  //   // console.log("forum.checkCatgories() with: ", [ 'music', 'movie', 'play', 'game', 'qna' ] );
  //   // this.forum.checkCategories( [ 'music', 'video', 'play', 'game', 'qna' ] ).then( re => {
  ...
  //   // this.forum.createPost( p, post => {
  //   //   // console.log( "Post created: ", post);

  //   //   this.forum.setCategoryPostRelation( post.key, post )
  //   //     .then( a => {
  //   //         // @todo check if success or false.
  //   //         console.log("success on set category post relation");
  //   //         console.log( a );
  //   //     })
  //   //     .catch( e => {
  //   //       console.log("caught on set category post relation");
  //   //       console.log(e);
  //   //     });
  //   // }, e => {
  //   //   console.log("error on set category post relation");
  //   //   this.error(e);
  //   // });
